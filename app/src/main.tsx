...
import ScheduleCoupler from "./modules/ScheduleCoupler";
import ScheduleViewer from "./modules/ScheduleViewer";
    ...
    <ThemeProvider>
      <BrowserRouter>
        <Routes>
          ...
          {/* Not shown in top nav, but routable directly */}
          <Route path="/coupler" element={<Layout><ScheduleCoupler /></Layout>} />
          <Route path="/schedule/view" element={<Layout><ScheduleViewer /></Layout>} />
